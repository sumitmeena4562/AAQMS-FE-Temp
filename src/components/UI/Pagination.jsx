...
const Pagination = ({
    ...
    return (
        <div className={`flex flex-col sm:flex-row items-center justify-between gap-4 w-full ${isGhost ? 'py-4' : 'px-6 py-4 bg-card border border-gray-400/80 rounded-2xl shadow-sm'} animate-in fade-in slide-in-from-bottom-2 ${className}`}>
            <div className="flex flex-col">
                <span className="text-[10px] font-black text-gray/70 uppercase tracking-[0.15em] leading-none mb-1">Navigation</span>
            ...
            <div className="flex items-center gap-1.5 bg-base/50 p-1.5 rounded-xl border border-gray-400/60 shadow-sm">
                <button
                        ...
                        <React.Fragment key={index}>
                            {page === '...' ? (
                                ...
                                <button
                                    ...
                                    className={`w-9 h-9 flex items-center justify-center rounded-lg text-[11px] font-black transition-all active:scale-95 ${currentPage === page
                ...
                <button
                    ...
                    className={`w-9 h-9 flex items-center justify-center rounded-lg transition-all ${currentPage >= totalPages
                            ? 'text-gray/20 cursor-not-allowed'
                            : 'text-gray hover:text-primary hover:bg-white shadow-sm active:scale-90 border border-transparent hover:border-border-main/50'
                        }`}
                >
