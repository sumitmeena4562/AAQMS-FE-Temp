...
const CoordinatorCard = ({ coordinator, orgName }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between !p-2 px-8 bg-card border border-border-main rounded-[var(--radius-card)] shadow-card hover:shadow-card-hover transition-all duration-300 gap-6">
      ...
      <div className="flex items-center gap-5 w-full md:w-[350px] shrink-0">
        ...
        <div className="flex flex-col justify-center">
          ...
          <span className="text-body text-[13px] font-medium mb-1.5 uppercase tracking-wide">ID: {id}</span>
      ...
      <div className="flex items-center w-[300px] shrink-0 gap-8">
        <div className="flex flex-col w-[120px]">
          <span className="text-gray text-[11px] font-bold uppercase tracking-widest mb-1.5">
            Managed Sites
          </span>
          <div className="flex items-baseline leading-none">
            ...
            <span className="text-body text-[15px] font-medium ml-1.5">Sites</span>
          </div>
        </div>
        <div className="flex flex-col w-[120px]">
          <span className="text-gray text-[11px] font-bold uppercase tracking-widest mb-1.5">
      ...
      <div className="w-full md:w-auto flex flex-1 justify-end shrink-0">
        <button 
          ...
          className="flex items-center justify-center gap-[6px] w-[131px] px-[14px] py-[6px] text-[12px] font-semibold text-primary bg-card border border-border-main rounded-full hover:bg-base transition-colors whitespace-nowrap"
        >
          View Site Plans
