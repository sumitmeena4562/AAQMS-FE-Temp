        ...
        <div style={{ minHeight: '100vh', background: 'var(--color-bg-primary)', overflowX: 'hidden' }}>
            ...
            <div className="hero-grid" style={{
                ...
                <div style={{ zIndex: 10 }}>
                    ...
                    <div className="hero-buttons" style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <div className="hero-card-container" style={{ zIndex: 10 }}>
                    <Card padding="20px" borderRadius="20px" style={{ width: '100%', maxWidth: '100%', border: '1px solid var(--color-border)' }} hoverEffect>
                        {/* Header */}
